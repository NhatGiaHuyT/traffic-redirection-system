...
if st.session_state.page == 'home':
    ...
    try:
        if st.session_state.page == 'traffic_video':
            exec(open(r"./src/Traffic_Video.py", encoding="utf-8").read())
        elif st.session_state.page == 'route_optimize_predictor':
            exec(open(r"./src/predictive_analysis_route_analysis.py", encoding="utf-8").read())
        elif st.session_state.page == 'smart_signal':
            exec(open(r"./src/SignalSimulation.py", encoding="utf-8").read())
