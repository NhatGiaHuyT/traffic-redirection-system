...
data_file = st.sidebar.text_input(lang_mapping[lang]["side_nav_data_file"], "./src/data/district5_complex_routes_with_datetime.csv")
graph_file = st.sidebar.text_input(lang_mapping[lang]["side_nav_graph_file"], "./src/ckpts/route_optimization_graph.pkl")
...
def export_filtered_data(dataframe, filename="./src/data/filtered_data.csv"):
    """
